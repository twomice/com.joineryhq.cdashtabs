 ...
 */
class CRM_Cdashtabs_Form_Settings extends CRM_Core_Form {

  public static $settingFilter = array('group' => 'cdashtabs');
  public static $extensionName = 'com.joineryhq.cdashtabs';
  ...
  public static function getSettings() {
    $settings = _cdashtabs_civicrmapi('setting', 'getfields', array('filters' => self::$settingFilter));
  ...
  public function saveSettings() {
    ...
    _cdashtabs_civicrmapi('setting', 'create', $values);
    ...
    _cdashtabs_civicrmapi('setting', 'create', $unsettings);
